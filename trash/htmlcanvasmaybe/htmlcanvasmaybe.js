...
lib.ssMetadata = [
		{name:"htmlcanvasmaybe_atlas_1", frames: [[0,0,553,1180]]}
];
...
(lib.CachedBmp_3 = function() {
	this.initialize(ss["htmlcanvasmaybe_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FF0000").s().p("ApuQOMAAAggbITdAAMAAAAgbg");
	...
	this.shape_1.graphics.f("#FF6347").s().p("AANP+QhQgDhhAKQARiEALkKQAGiXAHkyQhEioiwl4QiUk+hrjaQDKgpCuhOQAjB9BYD4QBgEQA/CMQCmnwA2ktQBvAvBMAaQBVAeBfAWQhgDqiEFOQh/FEg4CWQAABNgUFaQgZGigDBDQhbgNg8gDg");
	this.shape_1.setTransform(62.325,103.825);
...
// stage content:
(lib.htmlcanvasmaybe = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
// library properties:
lib.properties = {
	id: 'A384F0D30252429DA0ADE88FA8C716C2',
	width: 1608,
	height: 1084,
	fps: 24,
	color: "#FFFFFF",
	...
	manifest: [
		...
		{src:"images/htmlcanvasmaybe_atlas_1.png", id:"htmlcanvasmaybe_atlas_1"}
	],
	preloads: []
};
...
an.compositions['A384F0D30252429DA0ADE88FA8C716C2'] = {
